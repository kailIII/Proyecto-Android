 ...
 *
 */
public class ImagenProvider extends ContentProvider {
	public static final String PROVIDER_NAME = "sriFacture.proveedor.Imagen";
    public static final String ENTIDAD = "imagen";
