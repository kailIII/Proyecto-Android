 ...
 *
 */
public class FacturaProvider extends ContentProvider {
	public static final String PROVIDER_NAME = "sriFacture.proveedor.Factura";
    public static final String ENTIDAD = "factura";
    ...
    public static final String N_PROVEEDOR = "n_proveedor";
    public static final String FECHA = "fecha";
    public static final String TOTAL_GASTO = "total_gasto";
    public static final String RUC_PROVEEDOR = "ruc_proveedor";
