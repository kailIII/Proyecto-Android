 ...
 *
 */
public class DeducibleProvider extends ContentProvider{
	public static final String PROVIDER_NAME = "sriFacture.proveedor.Deducible";
    public static final String ENTIDAD = "deducible";
